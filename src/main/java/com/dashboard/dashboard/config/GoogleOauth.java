...
import com.dashboard.dashboard.domain.member.SocialOauth;
...
public class GoogleOauth implements SocialOauth {
    ...
    public String getOauthRedirectURL() {
        ...
        String formattedScope = GOOGLE_DATA_ACCESS_SCOPE.replace(",", "%20");
        params.put("scope", formattedScope); // Use the formatted scope
